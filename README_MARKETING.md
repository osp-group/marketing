...
```
marketing/
├── onboarding-portal/       # Portal web de onboarding (React + Vite)
│   ├── public/             # Assets públicos (fotos, logos)
│   ├── docs/               # Documentação e templates
│   ├── INSTRUÇÕES_SIMPLES.md  # Guia de atualização
│   ├── ABRIR_PORTAL.html   # Acesso rápido ao portal
│   └── README.md           # Instruções técnicas do portal
├── docs/
...
O portal de onboarding é uma aplicação React standalone para receber novos colaboradores.

**Acesso rápido:**
- 📖 [Instruções de Atualização](onboarding-portal/INSTRUÇÕES_SIMPLES.md) - Guia fácil para atualizar fotos e informações
- 🌐 [Abrir Portal](onboarding-portal/ABRIR_PORTAL.html) - Acesso direto ao webapp
- 🔧 [README Técnico](onboarding-portal/README.md) - Documentação técnica completa
